...
{
    internal class IsTheThreatSocial : AbstractDecisionNode
    {
        protected override bool EvaluateNode(PerceivedEvent perceivedEvent, Memory memory, CharacterTraits traits)
        {
            ...
            return IsItASocialThreat(perceivedAction.Message);
        }

        private static bool IsItASocialThreat(string threat)
        {
            var resourceSet = SocialThreatKeywords.ResourceManager.GetResourceSet(CultureInfo.CurrentCulture, true, true);
