...
{
    internal class IsTheThreatFinancial : AbstractDecisionNode
    {
        ...
        private static bool IsItAFinancialThreat(string threat)
        {
            var resourceSet = FinancialThreatKeywords.ResourceManager.GetResourceSet(CultureInfo.CurrentCulture, true, true);
